...
module lab9_soc_mm_interconnect_0 (
	...
	wire  [105:0] aes_decryption_0_aes_slave_agent_rf_source_data;                                    // AES_Decryption_0_AES_Slave_agent:rf_source_data -> AES_Decryption_0_AES_Slave_agent_rsp_fifo:in_data
	...
	wire  [105:0] aes_decryption_0_aes_slave_agent_rsp_fifo_out_data;                                 // AES_Decryption_0_AES_Slave_agent_rsp_fifo:out_data -> AES_Decryption_0_AES_Slave_agent:rf_sink_data
	...
	wire  [104:0] cmd_mux_src_data;                                                                   // cmd_mux:src_data -> AES_Decryption_0_AES_Slave_agent:cp_data
	wire          cmd_mux_src_ready;                                                                  // AES_Decryption_0_AES_Slave_agent:cp_ready -> cmd_mux:src_ready
	wire    [7:0] cmd_mux_src_channel;                                                                // cmd_mux:src_channel -> AES_Decryption_0_AES_Slave_agent:cp_channel
	...
	wire   [28:0] button_s1_agent_m0_address;                                                         // button_s1_agent:m0_address -> button_s1_translator:uav_address
	...
	wire  [104:0] cmd_mux_007_src_data;                                                               // cmd_mux_007:src_data -> button_s1_agent:cp_data
	wire          cmd_mux_007_src_ready;                                                              // button_s1_agent:cp_ready -> cmd_mux_007:src_ready
	wire    [7:0] cmd_mux_007_src_channel;                                                            // cmd_mux_007:src_channel -> button_s1_agent:cp_channel
	...
	wire  [104:0] aes_decryption_0_aes_slave_agent_rp_data;                                           // AES_Decryption_0_AES_Slave_agent:rp_data -> router_002:sink_data
	...
	wire  [104:0] button_s1_agent_rp_data;                                                            // button_s1_agent:rp_data -> router_009:sink_data
	...
	wire  [104:0] cmd_demux_001_src5_data;                                                            // cmd_demux_001:src5_data -> cmd_mux_007:sink1_data
	...
	wire  [104:0] rsp_demux_007_src1_data;                                                            // rsp_demux_007:src1_data -> rsp_mux_001:sink5_data
